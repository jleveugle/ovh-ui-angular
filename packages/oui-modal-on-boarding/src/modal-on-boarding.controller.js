...
export default class {
    ...
    $postLink () {
        ...
        if (this.panels[0]) {
            this.isIllustrated = !!this.panels[0].attributes.picture;
            ...
            $firstPanelElement.addClass("active init");
            this.$timeout(() => $firstPanelElement.removeClass("init"), INITIAL_TRANSITION);
        }
    ...
    _slide (direction, indexTo) {
        ...
        const nextIsIllustrated = !!this.panels[nextPanelIndex].attributes.picture;
    ...
    _setTouchEventListener () {
        if (this._contentElement) {
            ...
            this._contentElement.addEventListener("touchmove", evt => {
                ...
                // const minDiff = 150; // deal with short swipes
